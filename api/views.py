...
# APIView ning o'rniga generics.RetrieveUpdateDestroyAPIView quyilsa 3 qator kod bilan ishlaydi
...
#         book_review = BookReview.objects.get(id=id)
#         serializers = BookReviewSerializers(instance=book_review, data=request.data, partial=True)
#
#         if serializers.is_valid():
#             serializers.save()
#             return Response(data=serializers.data, status=status.HTTP_200_OK)
